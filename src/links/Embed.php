...
class Embed extends Link
{
     ...
     * and guards every request generated by the extractor, including discovered
     * endpoints and redirects, with pinned public DNS and bounded responses.
     */
    public static function fetchEmbedData(string $url, ?array $allowedDomains = null): array
    {
