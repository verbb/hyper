...
class Hyper extends Plugin
{
    ...
    private function _registerCpRoutes(): void
    {
        Event::on(UrlManager::class, UrlManager::EVENT_REGISTER_CP_URL_RULES, function(RegisterUrlRulesEvent $event) {
            ...
            $event->rules['hyper/settings/migrate/linkit'] = ['template' => 'hyper/settings/migrate/linkit'];
            $event->rules['hyper/settings/migrate/typed-link'] = ['template' => 'hyper/settings/migrate/typed-link'];
            $event->rules['hyper/settings/migrate/link'] = ['template' => 'hyper/settings/migrate/link'];
        });
    }
