    ...
    <div class="hyper-wrapper" :class="{ 'no-header': !showHeader }">
        <div v-show="showHeader" class="hyper-header">
            ...
            <div class="hyper-header-actions">
                ...
                <template v-if="!settings.isStatic || settings.multipleLinks">
                    <div v-if="settings.multipleLinks && linkType.tabCount > 1" class="hyper-header-settings ellipsis" @click.prevent="openSettings">
